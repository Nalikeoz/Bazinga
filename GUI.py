...
class MyApp(wx.App):
    ...
    def create_login_frame(self):
        self.login_frame = LoginFrame(parent=None, title="SquadViewer", size=(LOGIN_FRAME_WIDTH, LOGIN_FRAME_HEIGHT),
                               style=wx.SYSTEM_MENU | wx.MINIMIZE_BOX | wx.CAPTION | wx.CLOSE_BOX)
        self.SetTopWindow(self.login_frame)
        self.login_frame.Show()

    def create_main_frame(self):
        self.frame = MainFrame(parent=None, title="SquadViewer", size=(MAIN_FRAME_WIDTH, MAIN_FRAME_HEIGHT),
                               style=wx.SYSTEM_MENU | wx.MINIMIZE_BOX | wx.CAPTION | wx.CLOSE_BOX)
        self.SetTopWindow(self.frame)
        self.frame.Show()

    def create_chat_frame(self):
        self.chat_frame = ChatFrame(parent=None, title="SquadViewer Chat", size=(250, 480),
...
class LoginPanel(wx.Panel):
    ...
    def create(self):
        ...
        title = wx.StaticText(self, label="Login - SquadViewer\n")
